...
import WebRTCGroupChatService from "./WebRTCGroupChat/WebRTCGroupChatService/WebRTCGroupChatService";
...
export const leaveRoom = createAsyncThunk("room/leaveRoom", async () => {
